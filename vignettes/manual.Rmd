...
![Detail of default listing tab](images/list.jpg) 
...
![Detail of configuration tab](images/configure.jpg) 
...
`module_list` parameter of [`dv.manager::run_app`](https://boehringer-ingelheim.github.io/dv.manager/reference/run_app.html):
`r # nolint start`
